...
window.ARTICLE_CONTENT = {
  ...
  'income-req': {
    ...
    quotes: [
      ...
      { text: 'Сегодня забрала отказ по визе D. Они написали, якобы мой супруг получает поддержку от NAV. А в пояснении: раз бумажки опровергающей нет — значит получает. В списке документов этой бумаги не было, так что я про неё не знала.', author: 'J., 11.07.2025 · подача май 2025, переподача со справкой' }
    ],
    sources: [
  ...
  'visa-d': {
    ...
    quotes: [
      ...
      { text: 'Виза, которую дают, когда одобрили ВНЖ, только въездная. Можно только въехать. В течение нескольких дней с момента въезда нужно явиться в полицию и заказать карточку ВНЖ. Когда её получите, можете выезжать.', author: 'N.B., 20.06.2024' }
    ],
    sources: [
  ...
  'where-to-apply': {
    tldr: [
      'Главное правило UDI: подача из страны, где у вас есть гражданство или ВНЖ за последние 6 месяцев. Для российских граждан это обычно подача через VFS.',
      'Подача из Норвегии возможна как исключение — в основном если вы сами подходите под критерии <strong>Skilled worker (путь ВНЖ через ваше высшее или вокационное образование, не обязательно с работодателем)</strong>, или если ваше гражданство безвизовое.',
      'Для семей граждан ЕС/ЕЭЗ — отдельный процесс, обычно подача в полиции в Норвегии.',
      'Подача из Норвегии по шенгенской визе другой страны без подходящего основания официально не рекомендуется UDI и может привести к отказу.'
    ],
    actionNow: [
      'Определите, к какой из категорий вы относитесь: подача по гражданству/ВНЖ, Skilled worker через свой диплом, безвизовое гражданство, член семьи гражданина ЕС/ЕЭЗ.',
      'Если планируете подачу через Skilled worker — проверьте свой диплом по критериям UDI ещё до поездки.',
      'Запланируйте, где будете физически проводить ожидание ВНЖ (1–2 года) — это главная практическая разница между путями.'
    ],
    sections: [
      {
        title: 'Путь 1. Стандартный: подача из страны проживания',
        body: '<p>Главное правило UDI — подача из страны, где у вас есть гражданство или ВНЖ. Для российских граждан это означает подачу через визовый центр VFS. Документы сдаются в VFS, ожидание решения проходит дома. Подходит всем, у кого нет оснований для одного из исключений ниже.</p>'
      },
      {
        title: 'Путь 2. Skilled worker через ваш диплом',
        body: '<p>«Skilled worker» в UDI — это про <strong>вашу квалификацию</strong>, не про работодателя или работу в Норвегии. Если у вас есть одно из:</p><ul><li>Завершённое высшее образование (минимум бакалавр), например бакалавр инженерии, медсестры, экономики.</li><li>Завершённое вокационное образование минимум 3 года на уровне upper secondary, например плотник или медицинский работник, при условии, что аналогичная специальность признаётся в Норвегии.</li><li>Специальные квалификации через долгий профессиональный опыт (около 6 лет) в сочетании с курсами и образованием.</li></ul><p>Тогда вы можете легально въехать в Норвегию (по шенгенской визе или безвизу) и подать документы в полицию по месту жительства супруга. Ожидать решение можно в Норвегии — даже если ваша виза истечёт во время ожидания.</p><p>Важно: само наличие диплома не даёт права работать или учиться. Оно только даёт право подать заявление и ожидать решение в Норвегии. После одобрения семейной ВНЖ работать можно уже по семейному разрешению.</p><p>Не подходит само по себе: школьный аттестат, неоконченное высшее, краткосрочные курсы.</p>'
      },
      {
        title: 'Путь 3. Безвизовое гражданство',
        body: '<p>Если ваше гражданство не требует визы для въезда в Норвегию (например, гражданство США, Канады, Австралии и многих других стран), вы можете подать в Норвегии без статуса Skilled worker. Для российских граждан этот путь не работает.</p>'
      },
      {
        title: 'Путь 4. Воссоединение с гражданином ЕС/ЕЭЗ',
        body: '<p>Если ваш супруг — гражданин ЕС/ЕЭЗ (не Норвегии), процесс другой — это карта резидента семьи граждан ЕС/ЕЭЗ по директиве 2004/38/EC. Подаётся в полиции в Норвегии, обычно рассматривается быстрее, чем семейная миграция с гражданином Норвегии. Подробнее — в статье <a href="#">«Воссоединение с супругом — гражданином ЕС/ЕЭЗ»</a>.</p>'
      }
    ],
    faq: [
      { q: 'В чём практическая разница между подачей из России и из Норвегии?', a: 'Стандартный путь из России: документы в VFS, ожидание дома. Из Норвегии: документы в полицию по записи, ожидание в Норвегии. Главная разница — где вы физически проводите 1–2 года ожидания.' },
      { q: 'Можно ли подавать на ВНЖ из Норвегии, находясь по шенгенской визе другой страны?', a: 'UDI прямо пишет: «Не рекомендуется ехать в Норвегию, если у вас гостевая виза другой страны Шенгена. Если поедете, заявление на семейный ВНЖ может быть отклонено за указание ложной информации при получении визы». Исключение есть для Skilled worker и членов семьи граждан ЕС — им разрешено приехать с гостевой визой и оставаться до окончания рассмотрения.' },
      { q: 'Нужен ли мне диплом, если я подаюсь по семейной миграции?', a: 'Нет, для самой семейной миграции (стандартный путь из России) диплом не нужен. Он нужен только если вы хотите подаваться из Норвегии — для квалификации Skilled worker.' },
      { q: 'Какой статус нужен у супруга, чтобы я могла подаваться по семейной миграции?', a: 'Супруг должен иметь один из: гражданство Норвегии или Северных стран; ПМЖ; разрешение Skilled worker; статус направленного работника. Гражданство ЕС/ЕЭЗ — отдельный процесс по правилам ЕЭЗ.' },
      { q: 'Если я подаюсь из Норвегии, нужно ли мне там работать или иметь жильё?', a: 'Работать на норвежского или европейского работодателя во время ожидания ВНЖ нельзя. Удалённая работа на работодателя из России формально не запрещена. Жильё должно быть у супруга — это обычное требование семейного воссоединения.' },
      { q: 'Сколько примерно времени дело лежит у полиции до передачи в UDI?', a: 'По наблюдениям сообщества: для кейсов с гражданином ЕС полиция передаёт в UDI на следующий день (полиция Осло), для кейсов с гражданином Норвегии — обычно 8–10 дней.' }
    ],
    warn: '<p>Если подаёте из Норвегии по шенгенской визе, обратите внимание: онлайн-подача без явки в полицию не считается «подачей». После онлайн-подачи у вас есть несколько дней до фактической записи на сдачу биометрии. Точные сроки сверяйте через ваш UDI-кабинет — это критично, если виза заканчивается в момент подачи.</p><p>Сотрудники полиции в Норвегии не всегда знают актуальные правила UDI. Бывают случаи, когда сотрудник говорит, что вы не имеете право подавать из Норвегии — хотя на UDI это разрешено. По опыту участников чата помогает: распечатать соответствующий раздел сайта UDI и показать.</p>',
    tip: '<p>Если планируете подачу из Норвегии — проверьте свой диплом по критериям UDI <strong>до поездки</strong>. Если ваша специальность не подходит, путь Skilled worker для вас закрыт — лучше подавать из России.</p><p>Также подумайте о финансовой подушке: ожидание ВНЖ в Норвегии может занять год и больше, а работать в этот период нельзя (ни локально, ни на работодателя из ЕС). Удалённая работа на работодателя из России формально не запрещена.</p>',
    compare: {
      udi: 'UDI прямо пишет: «There are only a few situations where applying for family immigration while in Norway is acceptable». Главное правило — подача из страны гражданства. Подача из Норвегии — исключение для трёх категорий: Skilled worker, безвизовых граждан, членов семьи гражданина ЕС/ЕЭЗ.',
      practice: 'По кейсам сообщества подача в Норвегии через диплом — рабочий путь. Обычно сроки в полиции Осло короче официальных (например, ближайший слот на сайте — 10 недель, на практике — 7). Опытные участники советуют брать с собой распечатку соответствующих страниц UDI: некоторые сотрудники полиции не знают актуальных правил.'
    },
    quotes: [
      { text: 'У меня работник тоже не очень попался, запутал все документы, а потом в самом конце сказал, что я вообще не могу подавать из Норвегии. Но я сказала уверенно, что могу, и нашла скрины UDI, где написано, что можно по любому шенгену и с дипломом.', author: 'V.G., 22.01.2026 · диплом высшего, подача в полиции' },
      { text: 'Вам нужен диплом о средне-специальном или высшем образовании с апостилем и переводом на английский язык предоставить в полицию при подачи документов на воссоединение. Только в таком случае вы можете ожидать решения в Норвегии.', author: 'И.М., 11.12.2024 · подача в Норвегии через диплом' }
    ],
    sources: [
      ...
      { label: 'UDI: Skilled worker', url: 'https://www.udi.no/en/want-to-apply/work-immigration/skilled-workers/' }
    ]
  },
  ...
  'student-spouse': {
    ...
    actionNow: [
      ...
      'Если доход на грани — посмотрите статью <a href="#">«Требование по доходу принимающей стороны»</a> на предмет исключений.'
    ],
    sections: [
      {
  ...
  'refugee-6-month-window': {
    ...
    faq: [
      { q: 'Что если 6 месяцев уже прошли?', a: 'Можно подавать как обычная семейная миграция, но тогда применяется требование по доходу. Подробнее в статье <a href="#">«Требование по доходу принимающей стороны»</a>.' },
      ...
      { q: 'Если коллективная защита (например, украинцы) — действует ли то же окно?', a: 'Правила для коллективной защиты могут отличаться. Для конкретного кейса стоит свериться с UDI или юристом — общие правила «окно 6 месяцев» сформулированы для статуса беженца индивидуально.' }
    ],
  ...
  'after-refusal': {
    ...
    quotes: [
      { text: 'Был отказ из за отсутствия документа от нав (мы звонили в udi они сказали док им не нужен). Даже если в списке чего-то нет и мы это не принесли, это не может не служить поводом для отказа.', author: 'J., 06.11.2025 · супруг-норвежец, повторная подача — успешно' },
      { text: 'Я видела что это занимает 6 месяцев и что вроде как подаваться на такую же визу нельзя пока апелляция рассматривается.', author: 'J., 11.07.2025 · после отказа в визе D' },
      { text: 'С нами связался адвокат, который взялся за дело и как я поняла в Норвегии есть fri rettshjelp и наше дело по депортации подходит под эту категорию.', author: 'S., 25.01.2026 · дело о депортации' }
    ],
    sources: [
  ...
  'age-24-rule': {
    ...
    faq: [
      ...
      { q: 'Как доказать 2 года совместной жизни до переезда супруга?', a: 'Документы о совместной аренде, общие счета, фото и переписка за весь период. Подробнее в статье <a href="#">«Сожительство (samboer): как подтвердить 2 года совместной жизни»</a>.' },
  ...
  'application-documents': {
    ...
    faq: [
      ...
      { q: 'Нужен ли мой диплом при подаче?', a: 'Для воссоединения с супругом диплом заявителя НЕ требуется. Он нужен только если подаётесь из Норвегии как Skilled worker (через собственное образование). Подробнее — в статье <a href="#">«Где подавать заявление: из России или из Норвегии»</a>.' },
    ...
    quotes: [
      { text: 'Консультант говорит, что UDI хочет понимать, что у вас нормальный добровольный союз, и что вас никто не купил и не платил калым. Это чуть ли не важнее, чем доказать реальность отношений.', author: 'A.B., 14.05.2025 · супруг — Skilled worker' },
      { text: 'Я отправляла им оригинал свидетельства о браке обыкновенным письмом в Осло (скатетатен) вернулась обратно через 3-4 недели.', author: 'A., 16.01.2026 · о возврате оригиналов из Skatteetaten' }
    ],
    sources: [
  ...
  'police-appointment-prepare': {
    ...
    quotes: [
      { text: 'У меня работник тоже не очень попался, запутал все документы, а потом в самом конце сказал, что я вообще не могу подавать из Норвегии. Но я сказала уверенно, что могу, и нашла скрины UDI, где написано, что можно по любому шенгену и с дипломом.', author: 'V.G., 22.01.2026 · подача в полиции через диплом' }
    ],
    sources: [
  ...
  'processing-times': {
    ...
    quotes: [
      { text: 'Сейчас они сроки даже не пишут. При вводных: жена — гражданка РФ, муж — гражданин Норвегии, нет совместных детей и первая подача — они с 1 марта 2026 по 1 мая 2026 будут рассматривать заявления, поданные до 1 ноября 2024. Считайте, 1,5–2 года.', author: 'J., 08.04.2026 · супруг-норвежец, ВНЖ получен' },
      { text: 'Я из России подавалась, и да, полтора месяца всего ждала. Повезло, считаю.', author: 'N.B., 31.07.2024 · историческая быстрая обработка, сейчас редкость' }
    ],
    sources: [
  ...
  'police-registration-card': {
    ...
    quotes: [
      { text: 'По правилам я должна была в полицию в ближайшие 7 дней попасть с момента прибытия в страну, на что ему ответили: всё Ок, мы у себя отметили, что вы приедете раньше, но у нас нет свободного времени вас принять.', author: 'И.М., 04.06.2025 · о гибкости срока 7 дней' },
      { text: 'Я в итоге через 4 недели только пошла, никто ничего не сказал.', author: 'E.V., 21.06.2024 · подтверждение гибкости срока' }
    ],
    sources: [
  ...
  'd-number-fodselsnummer': {
    ...
    quotes: [
      { text: 'D-nummer — это временный номер, который вам дают, если вы приехали меньше, чем на полгода. Если дольше, то это сразу fødselsnummer.', author: 'A.B., 30.01.2026' },
      { text: 'Я называю DUF номер. Если не прокатывает — показываю распечатанную бумагу из UDI, где написано, что заявление принято на рассмотрение и присвоен этот номер DUF (он закреплён за человеком).', author: '«в р», 11.11.2024 · использование DUF до получения номера' },
      { text: 'Чтобы на них зарегистрироваться требуется электронное подтверждение. Пока у вас нет BankID это может быть MinID, но его только с D nummer можно получить. Замкнутый круг.', author: 'A.B., 20.03.2026 · о ловушке BankID' }
    ],
    sources: [
  ...
  'eu-eea-process': {
    ...
    quotes: [
      { text: 'Подавалась 14 февраля 2025 в полиции Осло на воссоединение с гражданином ЕС. На собеседование не звали. 22 июня 2025 пришёл имейл, что дали ВНЖ — итого 4 месяца.', author: 'D., 22.06.2025 · муж — гражданин Польши, подача в полиции Осло' },
      { text: 'В UDI на следующий день после подачи доков в полиции было передано мое дело.', author: 'D., 03.07.2025 · муж — гражданин ЕС' }
    ],
    sources: [
    ...
    sections: [
      {
        ...
        body: '<p>После одобрения ВНЖ всё идёт по понятной последовательности:</p><ol><li><strong>Приём в полиции</strong> — сдаёте биометрию (если не сдавали раньше), полиция заказывает карту. Подробнее — в статье «Регистрация в полиции и получение ВНЖ-карты».</li><li><strong>~2 недели после приёма</strong> — приходит письмо от Skatteetaten с D-номером или fødselsnummer. Подробнее — в статье «Получение D-номера и личного номера (fødselsnummer)».</li><li><strong>~3 недели после приёма</strong> — по почте приходит ВНЖ-карта.</li><li><strong>После получения fødselsnummer</strong> — регистрация по адресу в Folkeregisteret. Подробнее — в статье «Регистрация по адресу в Folkeregisteret».</li><li><strong>Параллельно</strong> — открытие банковского счёта, BankID, выбор fastlege, запись на языковые курсы.</li></ol>'
      },
      {
        title: 'Срок 7 дней — гибкий',
