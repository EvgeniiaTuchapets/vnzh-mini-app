...
window.ARTICLE_CONTENT = {
  ...
  'start-skilled': {
    tldr: [
      ...
      'Эта статья — про супруга с <strong>рабочим ВНЖ skilled worker</strong>. Если у него уже ПМЖ или гражданство Норвегии — правила другие, см. раздел «Если супруг уже получил ПМЖ или гражданство».'
    ],
    actionTitle: '🧭 Путь по шагам',
    actionNow: [
    ...
    sections: [
      ...
      {
        title: 'Если супруг уже получил ПМЖ или гражданство',
        body: '<p>Для UDI ваш кейс определяется не тем, как супруг когда-то переехал в Норвегию, а тем, <strong>какой документ у него на руках в момент вашей подачи</strong>. Если супруг приехал как skilled worker много лет назад, его статус мог уже измениться — и вместе с ним меняются правила для вас.</p><p><strong>У супруга ПМЖ (permanent oppholdstillatelse).</strong> Для UDI это уже другая категория принимающей стороны, и часть правил этой статьи не действует. Пакетной подачи нет — супругу нечего подавать вместе с вами. Требование по доходу становится строже: UDI проверяет не только текущий доход супруга, но и его доход за прошлый год по данным налоговой — льгота «без прошлогоднего дохода», которая действует для рабочего ВНЖ skilled worker, на ПМЖ не распространяется. Подробнее — в статье <a data-article=income-req>«Требование по доходу принимающей стороны»</a>. Есть и плюс: ваш статус больше не зависит от работодателя супруга — потеря работы не рушит основание проживания. В целом процесс ближе к кейсу «Гражданин Норвегии», ориентируйтесь также на статьи этого кейса.</p><p><strong>У супруга гражданство Норвегии.</strong> Это полностью кейс «Гражданин Норвегии» — переключите кейс в приложении и начните со статьи <a data-article=start-norwegian>«Воссоединение с супругом-норвежцем: что вас ждёт»</a>.</p>'
      }
    ],
  ...
  'student-spouse': {
    tldr: [
      ...
      '<strong>Подходит:</strong> учёба в университете или университетском колледже, языковой курс для Skilled worker.',
      '<strong>Не подходит:</strong> folkehøgskole (народная школа), videregående (старшая школа), Bibelskole (библейская школа), краткосрочные и онлайн-курсы без аккредитации.',
    ...
    actionNow: [
      ...
      'Определите статус супруга: он сам на студенческом ВНЖ или он норвежец / обладатель ПМЖ, который учится. От этого зависят правила по доходу.',
      'Посмотрите источники дохода супруга на год вперёд: стипендия, грант, заём Lånekassen, собственные средства на норвежском счёте, частичная работа.',
      'Если доход на грани — посмотрите статью <a data-article=income-req>«Требование по доходу принимающей стороны»</a> на предмет исключений.'
    ],
    sections: [
      {
        title: 'Какая учёба засчитывается',
        body: '<p>UDI признаёт учёбу супруга как основание для семейного воссоединения, только если у него один из этих типов разрешения:</p><ul><li>учёба в университете или университетском колледже (universitet / høyskole);</li><li>ВНЖ для языкового курса, признанного для Skilled worker.</li></ul><p>При <strong>любом другом</strong> типе студенческого разрешения члены семьи подаваться на воссоединение не могут. Не дают такого права, в частности:</p><ul><li>Folkehøgskole (народные школы — учёба «для себя», без степени);</li><li>Videregående skole (старшая школа);</li><li>Bibelskole (библейские школы);</li><li>краткосрочные курсы и онлайн-программы без аккредитации.</li></ul>'
      },
      {
        title: 'Доход — главная сложность, но правила зависят от статуса супруга',
        body: '<p>Требование по доходу применяется и к супругу-студенту, но как именно — зависит от того, кто он по статусу.</p><p><strong>Если супруг учится по студенческому ВНЖ (study permit).</strong> Для этой категории действует пониженный порог, и прошлогодний доход не требуется. Источником дохода могут быть стипендия, грант, студенческий заём, <strong>а также собственные средства супруга на норвежском банковском счёте</strong> (или на депозитном счёте учебного заведения) — или их комбинация. Узкое место в том, что иностранному студенту Lånekassen обычно недоступен, а одной университетской стипендии до порога чаще всего не хватает.</p><p><strong>Если супруг — норвежец или обладатель ПМЖ и при этом учится.</strong> Здесь ключевой переключатель — объём учёбы за последний год. Если супруг набрал не менее 60 кредитов за последний учебный/налоговый год (или прошёл полную программу в техническом колледже), UDI обычно делает исключение и применяет пониженный порог без проверки прошлогоднего дохода. Если объём учёбы меньше — действует стандартная проверка по доходу, как для любого работающего супруга этой категории.</p><p>Важно, что именно НЕ помогает в обоих случаях: накопления и недвижимость сами по себе доходом не считаются, и собственный доход заявителя (ваш) в расчёт не идёт. Есть редкая теоретическая лазейка для второго случая: при 60+ кредитах у супруга UDI может учесть будущую зарплату заявителя по уже подписанному норвежскому job offer (предложению о работе со стартом после получения ВНЖ — это не запрещённая работа во время ожидания). На практике в текущих реалиях получить такой оффер удалённо, ещё не находясь в Норвегии, почти нереально — рассчитывать на это не стоит.</p><p>Подробно про доход и исключения — в статье <a data-article=income-req>«Требование по доходу принимающей стороны»</a>.</p>'
      },
      {
        title: 'Период учёбы и ПМЖ',
        body: '<p>Если супруг сам находится в Норвегии по <strong>студенческому ВНЖ</strong>, время с этим разрешением не засчитывается в стаж для ПМЖ — ни ему, ни приехавшему по воссоединению супругу. Для накопления стажа нужен другой статус принимающей стороны (работа, ВНЖ Skilled worker и т.д.).</p><p>Если же супруг — гражданин Норвегии или обладатель ПМЖ, который просто параллельно учится, это ограничение к вам не относится: вы получаете обычный семейный ВНЖ, и он идёт в стаж для ПМЖ на общих основаниях.</p>'
      },
      {
        title: 'Сроки и порядок рассмотрения',
        body: '<p>В отличие от кейса Skilled worker, где UDI прямо обещает одновременные решения по заявкам супруга и семьи, для семей студентов такого обещания нет. Будьте готовы, что ваша семейная заявка может рассматриваться после того, как будет решена заявка самого студента — это способно удлинить общий срок переезда семьи.</p>'
      },
      {
        title: 'Если супруг — гражданин ЕС/ЕЭЗ',
        body: '<p>Эта статья описывает национальные правила UDI (типы учёбы, пороги дохода). Если ваш супруг — <strong>гражданин ЕС/ЕЭЗ</strong>, который учится в Норвегии, действует другой механизм: он «реализует право на проживание» как студент по правилам ЕЭЗ, и требований с фиксированным порогом дохода там нет. Подробнее — в статье <a data-article=eu-eea-residence-right>«Что значит «реализовывать право на проживание» (ЕС/ЕЭЗ)»</a>.</p>'
      }
    ],
    faq: [
      { q: 'Если супруг учится в folkehøgskole — можно ли подавать на семейное воссоединение?', a: 'Нет, folkehøgskole не даёт права на воссоединение. Нужно дождаться, пока супруг перейдёт на подходящий статус — например, поступит в университет или получит работу.' },
      { q: 'Можно ли подавать одновременно с заявкой супруга?', a: 'Для студентов UDI не обещает одновременных решений, как для Skilled worker. На практике семейная заявка может рассматриваться после студенческой, так что параллельная подача не гарантирует ускорения.' },
      { q: 'Если у супруга только стипендия — реально ли набрать порог дохода?', a: 'Сложно. Большинство университетских стипендий ниже порога, а Lånekassen иностранцам обычно недоступен. У студента на студенческом ВНЖ в порог могут засчитываться и собственные средства на норвежском счёте — но и их часто не хватает. Многие ждут, пока супруг найдёт работу или окончит учёбу.' },
      { q: 'А если у меня самой есть доход — это поможет?', a: 'По общему правилу нет: UDI смотрит на доход референс-персоны (супруга в Норвегии). Узкое исключение — если супруг набрал 60+ кредитов, теоретически может учитываться ваша будущая зарплата по подписанному норвежскому job offer, но удалённо получить такой оффер сейчас почти нереально.' }
    ],
    warn: '<p>Если супруг находится в Норвегии по студенческому ВНЖ, период этой учёбы не засчитывается в стаж для ПМЖ. Если планируете долгосрочный переезд и думаете о ПМЖ через несколько лет, учитывайте, что отсчёт стажа начнётся только после смены статуса супруга на рабочий или Skilled worker. На супруга-норвежца или обладателя ПМЖ, который учится, это ограничение не распространяется.</p>',
    sources: [
      { label: 'UDI: Frequently asked questions about study permits', url: 'https://www.udi.no/en/answer-pages/answers-study-permits/' },
      { label: 'UDI: Frequently asked questions about family immigration', url: 'https://www.udi.no/en/answer-pages/answers-family-immigration/' },
      { label: 'UDI: Income requirement in family immigration cases', url: 'https://www.udi.no/en/word-definitions/income-requirement-in-family-immigration-cases-/' }
    ]
  },
  ...
  'renew-when-how': {
    tldr: [
      'Подавайте на продление <strong>за 3 месяца</strong> до окончания текущего ВНЖ — это рекомендация UDI. При фактических сроках рассмотрения в несколько месяцев — лучше даже раньше.',
      'BankID (норвежская электронная подпись) <strong>не отменяет визит в полицию</strong> — биометрию при продлении сдают заново. С BankID часть процесса делается онлайн, и заявка регистрируется уже на этом этапе.',
      'Без BankID заявка регистрируется только с момента визита в полицию.',
      'Если успели подать <strong>за 1+ месяц</strong> до окончания текущего ВНЖ — сохраняете все права (работа, поездки, NAV) на время рассмотрения.',
    ...
    actionNow: [
      'За 3 месяца до окончания ВНЖ — войдите в личный кабинет на udi.no (через BankID, если есть, либо после регистрации).',
      ...
      'Запишитесь в полицию для сдачи биометрии — даже если у вас есть BankID. Запись делается через politiet.no.'
    ],
    sections: [
      {
        title: 'Когда именно подавать',
        body: '<p>UDI рекомендует подавать <strong>за 3 месяца до окончания</strong> текущего ВНЖ:</p><ul><li><strong>За 3 месяца</strong> — оптимально по рекомендации UDI. У UDI и полиции есть запас времени.</li><li><strong>За 1+ месяц</strong> — минимально допустимо. Все права сохраняются на время рассмотрения, даже если решение придёт после истечения старого ВНЖ.</li><li><strong>Меньше месяца или после истечения</strong> — рискованно. Часть прав может приостановиться.</li></ul><p>На практике 2026 года рассмотрение продления может занимать несколько месяцев, поэтому даже подача за 3 месяца не всегда успевает к решению. Чем раньше подадите — тем короче будет период «застревания» с истекшей картой (см. раздел ниже).</p>'
      },
      {
        title: 'Как происходит продление с BankID',
        body: '<p>Часть процесса — через личный кабинет на udi.no: вход через BankID → выбор «Renew family immigration permit» → заполнение онлайн-формы (UDI подтянет ваши данные из предыдущей заявки) → оплата пошлины → загрузка документов по персональному чек-листу → отправка.</p><p><strong>Визит в полицию после онлайн-этапа всё равно нужен</strong> — биометрию (отпечатки и фото) при продлении сдают заново, данные из первой подачи не переиспользуются.</p><p>Главное преимущество BankID — момент подачи. С BankID заявка считается официально поданной с онлайн-этапа, ещё до визита в полицию. Это важно по двум причинам:</p><ol><li><strong>Сохраняет легальный статус</strong>, если визит в полицию назначен на дату после окончания текущего ВНЖ.</li><li><strong>Раньше попадаете в очередь рассмотрения</strong> — потенциально получаете решение быстрее.</li></ol><p>Без BankID онлайн-этап тоже есть, но заявка считается поданной только после визита в полицию.</p>'
      },
      {
        title: 'Как происходит продление без BankID',
        body: '<p>Без BankID онлайн делается только подготовка: регистрация заявки и оплата пошлины. Визит в полицию обязателен — там сдаётся биометрия и официально регистрируется подача. Запись делается через politiet.no.</p><p><strong>Дата подачи в этом случае — день визита в полицию</strong>, а не онлайн-этапа. Это важно учитывать при планировании, чтобы успеть в срок до окончания текущего ВНЖ.</p>'
      },
      {
        title: 'Что значит «сохранение прав»',
        body: '<p>Если вы подали на продление <strong>до истечения</strong> текущего ВНЖ, у вас сохраняются: право на работу, право на поездки в Шенген, доступ к NAV, медицине, образованию, регистрация в Folkeregisteret (регистр населения).</p><p>Это право подтверждается документом <strong>kvittering for søknad</strong> (подтверждение подачи). Сохраняйте его и предъявляйте, если возникнут вопросы у работодателя, банка или при пересечении границы.</p><p>Подавать максимально заранее — практическая защита. При фактических сроках рассмотрения в несколько месяцев даже подача за 3 месяца не всегда успевает к решению. Часть периода вы будете жить с истекшей картой, но сохранёнными правами по kvittering — этот период короче, если подача была раньше.</p>'
      },
      {
        title: 'Если ВНЖ-карта истекает во время рассмотрения',
        body: '<p>Сама ВНЖ-карта (пластиковая) может физически истечь до получения решения по продлению. <strong>Внутри Норвегии</strong> права сохраняются на основании поданной заявки и kvittering.</p><p><strong>Поездки за рубеж — рискованны в обоих направлениях.</strong> UDI прямо предупреждает: без действующей резидент-карты вас могут остановить на пограничном контроле других стран при выезде, а также возникнут сложности при возвращении в Норвегию. Если поездка необходима — заранее уточняйте у UDI или у полиции, какие есть варианты в вашем случае.</p>'
      }
    ],
    faq: [
      { q: 'До окончания ВНЖ несколько недель, только сейчас узнал что надо продлевать — что делать?', a: 'Подайте онлайн прямо сейчас. Даже неполный пакет лучше, чем пропуск дедлайна — UDI обычно запрашивает недостающие документы отдельно. Главное — успеть зарегистрировать заявку до истечения. Если у вас есть BankID — заявка зафиксируется с момента онлайн-подачи; визит в полицию можно будет пройти позже.' },
      ...
      { q: 'Можно ли продлить ВНЖ дистанционно, без приезда в Норвегию?', a: 'Нет. Даже с BankID часть процесса проходит онлайн, но визит в полицию для сдачи биометрии обязателен. Без BankID — то же самое, только онлайн-этап короче. Из-за рубежа продлить нельзя.' },
      { q: 'Сколько занимает рассмотрение продления?', a: 'На практике в 2026 году может занимать несколько месяцев — в полиции Осло озвучивают порядка 5–7 месяцев, в других регионах сроки плавающие. Это заметно дольше «нескольких недель», как часто звучит в общих ориентирах. Актуальный ориентир — на странице «Guide to waiting time» на udi.no, тип заявки — renewal.' },
      { q: 'Можно ли подать продление за 6 месяцев до окончания?', a: 'Технически да. Но смысла обычно нет: продление не делается «впрок», и новый ВНЖ начинает отсчитываться с момента окончания старого. UDI рекомендует именно 3 месяца как оптимальный срок.' },
  ...
  'apply-with-skilled-worker': {
    ...
    sections: [
      ...
      },
      {
        ...
        body: '<p>Если принимающая сторона уже получила ВНЖ Skilled worker, и вы подаёте позже — это стандартная семейная миграция, и пакетных преимуществ нет. Сроки в этом случае обычные для семейной миграции к Skilled worker (4–6 месяцев при порядке с документами).</p><p>А если принимающая сторона уже получила ПМЖ или гражданство Норвегии — это другой кейс с другими правилами, и эта статья не про вашу ситуацию. С чего начать — раздел «Если супруг уже получил ПМЖ или гражданство» в статье <a data-article=start-skilled>«Воссоединение с супругом — Skilled worker: что вас ждёт»</a>.</p>'
      }
    ],
    faq: [
