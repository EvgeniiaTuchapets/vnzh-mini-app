...
window.ARTICLE_CONTENT = {
  ...
  'application-documents': {
    ...
    faq: [
      ...
      { q: 'Нужен ли мой диплом при подаче?', a: 'Для воссоединения с супругом диплом заявителя НЕ требуется. Он нужен только если подаётесь из Норвегии как Skilled worker (через собственное образование). Подробнее — в статье <a href="#"><a data-article=where-to-apply>«Где подавать заявление: из России или из Норвегии»</a>.' },
