  ...
  'start-norwegian': {
    ...
    sections: [
      ...
      },
      {
        ...
        body: '<p>Стандартный путь — подача из страны, где вы проживаете, через визовый центр VFS. Подача из Норвегии возможна не всегда — нужны определённые основания.</p><p>Подробно про оба варианта — в статье <a data-article=where-to-apply-norwegian>«Где подавать заявление: из России или из Норвегии»</a>.</p>'
      },
      {
  ...
  'start-skilled': {
    ...
    sections: [
      ...
      },
      {
        ...
        body: '<p>Стандартный путь — подача из страны проживания через визовый центр VFS. Если вы сами подходите под критерии skilled worker по образованию, может быть возможна подача из Норвегии. Подробно — в статье <a data-article=where-to-apply-skilled>«Где подавать заявление: из России или из Норвегии»</a>.</p><p>Во время ожидания работать на норвежского или европейского работодателя нельзя, даже удалённо.</p>'
      },
      {
        title: 'К чему морально готовиться',
