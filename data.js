...
window.ARTICLE_CONTENT = {
  ...
  'visa-d': {
    ...
    quotes: [
      ...
      { text: 'Виза, которую дают, когда одобрили ВНЖ, только въездная. Можно только въехать. В течение нескольких дней с момента въезда нужно явиться в полицию и заказать карточку ВНЖ. Когда её получите, можете выезжать.', author: 'Участник сообщества, 20.06.2024' }
    ],
    sources: [
