...
window.ARTICLE_CONTENT = {
  ...
  'after-refusal': {
    ...
    quotes: [
      ...
      { text: 'Я видела что это занимает 6 месяцев и что вроде как подаваться на такую же визу нельзя пока апелляция рассматривается.', author: 'Julia, 11.07.2025 · после отказа в визе D' },
  ...
  'processing-times': {
    ...
    quotes: [
      ...
      { text: 'Я из России подавалась, и да, полтора месяца всего ждала. Повезло, считаю.', author: 'Natalia Brasrud, 31.07.2024 · историческая быстрая обработка, сейчас редкость' }
    ],
    sources: [
  ...
  'police-registration-card': {
    ...
    quotes: [
      ...
      { text: 'Я в итоге через 4 недели только пошла, никто ничего не сказал.', author: 'Elina Volkova, 21.06.2024 · подтверждение гибкости срока' }
    ],
    sources: [
